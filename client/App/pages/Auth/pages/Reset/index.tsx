    ...
    return (
      <div className="mt-reset mt-auth">
        <div className="mt-auth__form-container">
          ...
          <p className="mt-auth__description">Please fill the fields below to change your password.</p>
          <form className="mt-auth__form" onSubmit={this.handleSubmit}>
            ...
            <div className="mt-auth__actions">
              <Button type="submit" variant="contained" color="secondary" size="large" fullWidth={true}>
                Change password
              </Button>
            </div>
          </form>
