...
import { UPDATE_TASK_REQUEST, DELETE_TASK_REQUEST, START_TASK_EDITING, CANCEL_TASK_EDITING } from './constants';
        ...
        <div className="mt-task-container">
          <div className="mt-task">
            <span className="mt-task__status" onClick={this.updateTaskStatus}>
              {status === 'TODO' ? (
                <svg
                  className="mt-task__status--todo"
                ...
                <svg
                  className="mt-task__status--done"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
      ...
      <div className="mt-task__form-container">
        <form className="mt-task__form" onSubmit={this.updateTaskTitle}>
          ...
          <div className="mt-task__actions">
            ...
            <Button variant="contained" color="default" size="medium" onClick={this.cancelEditing}>
              Cancel
            </Button>
          </div>
        </form>
