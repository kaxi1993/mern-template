        ...
        <div className="mt-container">
          <div className="mt-footer__inner">
            <div className="mt-footer__section">
              <h5 className="mt-footer__section-title">Services</h5>
              <ul className="mt-footer__section-list">
                <li className="mt-footer__list-item">
                  <a href="#" className="mt-footer__item-link">
                    Service One
                  </a>
                </li>
                <li className="mt-footer__list-item">
            ...
            <div className="mt-footer__section">
              <h5 className="mt-footer__section-title">About Us</h5>
              <ul className="mt-footer__section-list">
                <li className="mt-footer__list-item">
                  <a href="#" className="mt-footer__item-link">
                    Teams
            ...
            <div className="mt-footer__section">
              <h5 className="mt-footer__section-title">Help & FAQ</h5>
              <ul className="mt-footer__section-list">
                <li className="mt-footer__list-item">
                  <Link to="/terms" className="mt-footer__item-link">
                    Terms of Service
                  </Link>
                </li>
                <li className="mt-footer__list-item">
                  <Link to="/privacy" className="mt-footer__item-link">
                    Privacy Policy
                  </Link>
                </li>
                <li className="mt-footer__list-item">
        ...
        <ul className="mt-footer__social-list">
          <li className="mt-footer__social-item">
            <a href="https://facebook.com" className="mt-footer__social-link" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="mt-footer__social-icon">
